...
const projects = [
  {
    ...
    date: "January 2025",
    liveDemo: "https://resume.nowhile.com",
    description: [
...
export default function ResumePage() {
  ...
  const handleDownloadResume = async () => {
    try {
      const response = await fetch("/Ansh_Shah_Resume.jpg")
      if (!response.ok) {
      ...
      link.href = url
      link.download = "Ansh_Shah_Resume.jpg"
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-12 pt-28 sm:pt-32 relative overflow-hidden">
        {/* Background Elements */}
                ...
                <CardContent>
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-sm sm:text-base">xxxxxxx</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
