...
export class NavbarComponent {
  ...
  readonly headerClass = computed(() => {
    ...
    return cn(
      'fixed top-4 left-0 right-0 z-50 w-full flex justify-center pointer-events-none transition-transform duration-300 ease-[cubic-bezier(0.32,0.72,0,1)]',
  ...
  readonly innerClass = computed(() => {
    ...
    return cn(
      'inner pointer-events-auto rounded-full border transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)] px-5 sm:px-6 w-[92%] sm:w-fit',
      condensed
