...
export class NavbarComponent {
  ...
  readonly headerClass = computed(() => {
    ...
    return cn(
      ...
      condensed ? 'w-[92%] md:w-fit' : 'w-[96%] md:w-[90%] lg:w-[85%] max-w-4xl',
      visible
  ...
  readonly innerClass = computed(() => {
    ...
    return cn(
      ...
      condensed
        ? 'bg-white/95 dark:bg-[#0C0C0E]/85 backdrop-blur-xl dark:backdrop-blur-[16px] shadow-xl shadow-black/5 dark:shadow-black/35 border-primary/20 dark:border-[#252528] py-2'
        : 'bg-white/90 dark:bg-[#0C0C0E]/85 backdrop-blur-md dark:backdrop-blur-[16px] border-white/40 dark:border-[#252528] shadow-sm py-2.5'
    );
  });
}
