                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            required
                            className="h-11 rounded-xl border-2 transition-all duration-200 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 bg-background/50"
                          />
                        </div>
                        <div className="space-y-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <Textarea
                          ...
                          onChange={handleChange}
                          required
                          className="resize-none rounded-xl border-2 transition-all duration-200 focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 bg-background/50"
                        />
                      </div>
