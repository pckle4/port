...
const defaultResumeData: ResumeData = {
  ...
  technicalSkills: {
    languages: "Java, C, HTML/CSS, JavaScript, C++, SQL",
    tools: "VS Code, Eclipse, Android Studio, Git",
    technologies: "Linux, GitHub, WordPress, React, Node.js",
  },
  projects: [
    {
...
// Helper to split strings by comma and trim
        ...
        >
          <div className="max-w-4xl mx-auto">
            ...
            <div className={`mb-8 flex flex-col sm:flex-row items-center justify-between gap-4 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                ...
                <Button
                  asChild
                  className="rounded-full bg-foreground text-background hover:bg-foreground/90 shadow-lg hover:shadow-xl transition-all hover:-translate-y-0.5"
                >
                  <a href="/resume.pdf" download="Ansh_Shah_Resume.pdf">
            ...
            >
              ...
              <div className="flex flex-wrap justify-center gap-4 text-sm sm:text-base mt-4">
                 <a href={`mailto:${resumeData.personalInfo.email}`} className="flex items-center text-muted-foreground hover:text-foreground transition-colors px-3 py-1.5 rounded-full bg-secondary/30 border border-border/50 hover:bg-secondary/50">
                    <Mail className="h-4 w-4 mr-2 text-purple-500" />
                    {resumeData.personalInfo.email}
                 </a>
                 <a href={`https://${resumeData.personalInfo.linkedin}`} target="_blank" rel="noopener noreferrer" className="flex items-center text-muted-foreground hover:text-blue-500 transition-colors px-3 py-1.5 rounded-full bg-secondary/30 border border-border/50 hover:bg-secondary/50">
                    <Linkedin className="h-4 w-4 mr-2 text-blue-500" />
                    LinkedIn
                 </a>
                 <a href={`https://${resumeData.personalInfo.github}`} target="_blank" rel="noopener noreferrer" className="flex items-center text-muted-foreground hover:text-foreground transition-colors px-3 py-1.5 rounded-full bg-secondary/30 border border-border/50 hover:bg-secondary/50">
            ...
            <div className="grid gap-8">
                  ...
                  <CardContent className="p-6 relative">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="text-right flex flex-col items-start md:items-end mt-2 md:mt-0">
                            <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-blue-500/10 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-800">
                        ...
                        <Card key={idx} className="group border-border/50 bg-background/50 backdrop-blur-sm hover:border-pink-500/30 hover:shadow-md transition-all duration-300">
                            <CardContent className="p-5">
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-3">
                                    ...
                                    <span className="text-xs font-medium text-muted-foreground bg-secondary/50 px-2.5 py-1 rounded-full border border-border/50 self-start sm:self-center">
                                        {project.date}
                                    </span>
                                </div>
              ...
              <div className={`transition-all duration-700 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                ...
                {resumeData.leadership.map((item, idx) => (
                    <Card key={idx} className="border-border/50 bg-background/50 backdrop-blur-sm hover:border-yellow-500/30 hover:shadow-md transition-all duration-300">
                        <CardContent className="p-6">
                            <div className="flex flex-col sm:flex-row justify-between gap-2 mb-4">
                                ...
                                <div className="text-right">
                                    <span className="inline-block text-xs font-medium text-muted-foreground bg-secondary px-2 py-1 rounded">
                                        {item.date}
                                    </span>
                                </div>
                            </div>
                            <ul className="space-y-2 mt-2 bg-yellow-50/50 dark:bg-yellow-900/5 p-4 rounded-lg border border-yellow-100 dark:border-yellow-900/20">
