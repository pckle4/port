  ...
  return (
    <footer className="bg-black text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 relative">
        ...
        {/* Current Time & Date Section - Responsive */}
        <div className="border-t border-gray-800 mt-8 sm:mt-12 pt-6 sm:pt-8">
          <div className="text-center mb-4 sm:mb-6">
            <div className="bg-gradient-to-r from-purple-900/30 to-blue-900/30 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-purple-500/20 max-w-md mx-auto">
              <div className="flex items-center justify-center space-x-2 sm:space-x-4 mb-2 sm:mb-4">
                <Clock className="h-4 w-4 sm:h-6 sm:w-6 text-purple-400" />
                <span className="text-lg sm:text-2xl font-mono text-white">{formatTime(currentTime)}</span>
              </div>
              <div className="flex items-center justify-center space-x-2 text-gray-400">
                <Calendar className="h-3 w-3 sm:h-4 sm:w-4" />
                <span className="text-xs sm:text-sm">{formatDate(currentTime)}</span>
              </div>
              <div className="text-xs text-gray-500 mt-1 sm:mt-2">India Standard Time (IST)</div>
            </div>
          </div>
          ...
          <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-800/50">
            <div className="text-center space-y-2">
              ...
              <p className="text-xs text-gray-600 max-w-4xl mx-auto leading-relaxed">
                This website and its content are protected by copyright law. Unauthorized reproduction, distribution, or
                use of any materials from this site is strictly prohibited without prior written permission.
              </p>
