      ...
      <div ref={sectionRef} className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <h2 ref={titleRef} className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold mb-4">
              Let's Work Together
            </h2>
              ...
              <div ref={cardsRef}>
                ...
                <div className="grid gap-4">
                  {contactInfo.map((info, index) => (
                    <div
                      key={index}
                      className="contact-card group p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-background to-muted/50 border border-border/50 hover:border-border transition-all duration-300 hover:shadow-lg cursor-pointer magnetic-card"
