  ...
  return (
    <div className="relative">
      <div className="flex items-center justify-between mb-3">
        <h5 className="text-sm font-medium text-gray-300">System Information</h5>
        <button
          ...
          <CardContent className="p-4">
            {isLoading ? (
              <div className="flex items-center justify-center py-6">
                ...
                <span className="ml-2 text-gray-400 text-sm">Detecting IP address...</span>
              </div>
            ) : systemInfo ? (
              <div className="space-y-3">
                <div className="flex items-center justify-between p-2 rounded-lg bg-black/30">
                  ...
                  <span className="text-green-400 font-mono text-sm">{systemInfo.ip}</span>
                </div>
                ...
                <div className="flex items-center justify-between p-2 rounded-lg bg-black/30">
                  ...
                  <span className="text-purple-400 text-sm truncate max-w-32">{systemInfo.isp}</span>
                </div>
              </div>
            ) : (
              <div className="text-center py-4 text-gray-500 text-sm">Click the eye icon to reveal system details</div>
            )}
          </CardContent>
        </Card>
