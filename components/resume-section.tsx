...
export function ResumeSection() {
  ...
  useEffect(() => {
    ...
    // Cards animation
    const cards = cardsRef.current?.querySelectorAll(".resume-card")
    if (cards) {
      gsap.fromTo(
        cards,
...
${leadership.description.map((desc) => `• ${desc}`).join("\n")}
    ...
    a.href = url
    a.download = "Ansh_Shah_Resume.pdf"
        ...
        <div ref={sectionRef} className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div ref={headerRef} className="text-center mb-12">
              <h1 className="text-4xl sm:text-5xl font-bold mb-4 bg-gradient-to-r from-purple-600 via-blue-600 to-cyan-600 bg-clip-text text-transparent">
                Resume
              </h1>
              <p className="text-xl text-muted-foreground mb-6">Full Stack Developer & Computer Engineering Student</p>
              <Button
                onClick={handleDownloadPDF}
                className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-6 py-3 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
              >
            ...
            <div ref={cardsRef} className="grid gap-8">
              ...
              <Card className="resume-card shadow-lg border-0 bg-gradient-to-br from-background to-muted/30">
                <CardHeader>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                      ...
                      <div className="flex items-center space-x-2">
                        <Calendar className="h-4 w-4 text-muted-foreground" />
                        <span className="text-sm text-muted-foreground">{leadership.date}</span>
                      </div>
                    </div>
                    <ul className="space-y-2">
